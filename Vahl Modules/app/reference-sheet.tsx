    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.content, { paddingBottom: Math.max(insets.bottom, 20) }]}>
        ...
        <View style={styles.mainContent}>
          <Image
            source={require("../assets/images/ref_image.png")}
            style={[
              styles.welcomeImage,
              {
          ...
          <Text style={[
            ...
            If you have any questions, please check the reference tab to see FAQs and general information about Norooz Clinic.
          </Text>
        </View>
