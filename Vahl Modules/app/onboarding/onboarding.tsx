import { View, Text, StyleSheet, Image, SafeAreaView, Dimensions, TouchableOpacity, Platform } from "react-native"
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.content, { paddingBottom: Math.max(insets.bottom, 20) }]}>
        <View style={styles.mainContent}>
          ...
          >
            The purpose of the onboarding is the ensure you have the tools and resources to be successful at Norooz.
          </Text>
          <Text
            style={[
              styles.description,
          ...
          >
            You have 7 onboarding modules with videos and quizzes to go through and each module will have an exam to
            make sure you understand all of our policies and procedures.
          </Text>
        </View>
